...
class EGGSVoltagesCalibration(LAXExperiment, EnvExperiment):
    ...
    Examines the power of red sb vs blue sb
    """
    ...
    def prepare_experiment(self):
        ...
        self.freq_eggs_secular_hz_list = np.array(list([self.freq_eggs_heating_secular_khz])) * kHz
    ...
    def run_main(self):
        ...
        for trial_num in range(self.repetitions):
            ...
            for config_vals in self.config_eggs_heating_list:
                ...
                self._run_eggs(carrier_freq_hz, self.freq_eggs_secular_hz, phase_rsb_turns, freq_readout_ftw,
    ...
    def _run_eggs(self, carrier_freq_hz, sideband_freq_hz, phase_rsb_turns, freq_readout_ftw,
        ...
        if ampl_rsb_frac != 0 and ampl_dd_frac != 0:
            _rsb_qvsa_flag = True
        else:
            _bsb_qvsa_flag = True
    ...
    def analyze_experiment(self):
        ...
        secular_freq_hz = self.freq_eggs_secular_one_sb_hz  ### assume one secular frequency used
        ...
        assert len(bsb_qvsa_phonons) == len(rsb_qvsa_phonons), "Length Mismath"
