...
_DMA_HANDLE_INITIALIZE = "heating_rate_qadj_initialize"
_DMA_HANDLE_SIDEBAND = "heating_rate_qadj_pulse"
_DMA_HANDLE_READOUT = "heating_rate_qadj_readout"


class HeatingRateMeasurementQubitReadoutAdjust(EnvExperiment):
    """
    Heating Rate Measurement - Qubit Readout Adjust
        ...
        for trial_num in range(self.repetitions):
            ...
            for time_heating_delay_mu in self.time_heating_rate_list_mu:
                ...
                for freq_ftw in self.freq_qubit_scan_ftw:
                    ...
                    self.dds_qubit.set_mu(freq_ftw, asf=self.ampl_readout_pipulse_asf, profile=0)
                    self.core.break_realtime()
