...
class SidebandCoolingWithCarrier(EnvExperiment):
    """
    Sideband Cooling With Carrier
    ...
    def build(self):
        ...
        self.setattr_argument("freq_carrier_scan_mhz",                  Scannable(
                                                                            default=CenterScan(104.24, 0.04, 0.001),
                                                                            global_min=30, global_max=200, global_step=1,
                                                                            unit="MHz", scale=1, ndecimals=5
                                                                        ))
