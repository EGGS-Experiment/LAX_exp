...
class TemperatureMeasurement(EnvExperiment):
    ...
    def prepare(self):
        ...
        asf_vals = np.array([.15625,.140625,.125,.125,.109375,.109375,.109375,.1171875,.1171875,.109375,.109375,.109375,.1171875,.1171875,.125,.125,.125,.140625,.40625,.15625,.15625,.1875,.21875,.25,.3125])
