...
class PIDTest2(EnvExperiment):
    ...
    def prepare(self):
        ...
        self.set_dataset(self.dataset_name, np.zeros([self.num_points, 8]), broadcast=True)
    ...
    def run(self):
        ...
        # tmp remove
        self.dac.set_dac(0, 0.5)
        self.dac.set_dac(1, 0.6)
        # tmp remove
        # PID loop
        loop_counter = 0
        for i in range(self.num_points):
            ...
            # store values
            self.mutate_dataset("sampler_readout", i, self.sampler_buffer)
            # get error value
    ...
    def prepareDevices(self):
        ...
        self.adc.init()
        self.core.break_realtime()
        self.adc.set_gain_mu(self.channel_feedback, 2)
        self.adc.set_gain_mu(self.channel_setpoint, 2)
        self.core.break_realtime()
        # set up fastino
        self.dac.init()
        self.core.break_realtime()
        ...
        self.dac.set_dac(self.channel_output, 0)
        self.core.break_realtime()
