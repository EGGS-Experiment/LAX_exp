...
class UrukulTest(EnvExperiment):
    ...
    def run(self):
        ...
        self.urukul0_ch0.cfg_sw(1)          # switches the DDS channel on/off (on=1, off=0)
        self.core.break_realtime()
        self.urukul0_ch0.set_mu(self.frequency_mu, 0, self.amplitude_mu)     # uncomment this line when you want to change frequency
        #self.urukul1_ch0.cfg_sw(1)
        self.urukul0_ch0.set_att(10 * dB)                   # set channel attenuation; has a range between 0dB and 31.5dB attenuation
