...
class PMT_experiment(EnvExperiment):
    ...
    def build(self):
        ...
        # experiment runs
        self.setattr_argument("repetitions", NumberValue(default=10000, ndecimals=0, step=1, min=1, max=30000))
    ...
    def analyze(self):
        ...
        print('mean:', mean(pmt_counts))

        # set discrimination levels
        self.set_dataset("pmt_discrimination", mean(pmt_counts), broadcast=True, persist=True)
