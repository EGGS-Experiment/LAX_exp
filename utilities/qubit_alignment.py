...
class QubitAlignment(LAXExperiment, Experiment):
    ...
    def prepare_experiment(self):
        ...
        self.set_dataset('_tmp_counts_y',       np.zeros(self.repetitions), broadcast=True, persist=False, archive=False)
    ...
    def update_results(self, iter_num, state_array):
        ...
        # update datasets
        self.mutate_dataset('_tmp_counts_x', self._result_iter, iter_num * (self.samples_per_point * self.time_per_point_us * us))
        self.mutate_dataset('_tmp_counts_y', self._result_iter, dstate_probability)
