...
class sampler_exp(EnvExperiment):
    ...
    def build(self):
        ...
        self.setattr_argument("channel_gain_10dB", NumberValue(default=10, ndecimals=0, step=1, min=0, max=3))
    ...
    def update_dataset(self, adc_mu):
        ...
        """
        self.append_to_dataset("sampler_readout", adc_mu * self.adc_mu_to_volts)
