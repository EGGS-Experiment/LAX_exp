...
class IonSpectrumAnalyzerDDSLatencyAdjust(IonSpectrumAnalyzer.IonSpectrumAnalyzer):
    """
    Experiment: Ion Spectrum Analyzer DDS Latency Adjust
    ...
    ***todo: redocument***
    ...
    def build_experiment(self):
        ...
        self.setattr_argument("phase_ISA_DDS_rsb_turns",                    NumberValue(default=0., ndecimals=3, step=0.1, min=-1.0, max=1.0), group='EGGS_Heating.waveform.time_phase')
    ...
    def dds_configure(self, carrier_freq_hz: TFloat, sideband_freq_hz: TFloat, offset_freq_hz: TFloat,
        ...
        # channel 0 (RSB)
        self.phase_ch0_osc0 =   self.phase_ISA_DDS_rsb_turns
        self.phase_ch1_osc0 =   (freq_rsb_hz * (self.time_urukul1_ch1_latency_ns * ns)
                                 + self.phase_ISA_DDS_rsb_turns
                                 + phase_rsb_turns)
