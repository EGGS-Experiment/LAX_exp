...
class EGGSHeatingAutomated(SidebandCooling.SidebandCooling):
    """
    Automated EGGs Heating
    """
    ...
    def process_func_1(self, results_list):
        ...
        self.experiment_parameters['freq_eggs_heating_secular_khz_list.center'] = (new_peak_values[0] - new_peak_values[
            1]) * 2000. + 0.5
        self.experiment_parameters['freq_sideband_cooling_mhz_pct_list'] = pyon.encode(
            {new_peak_values[1] - 0.00175: 100.})
