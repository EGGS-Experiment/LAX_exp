...
class IonSpectrumAnalyzerDDSCarrierAttenuation(IonSpectrumAnalyzer.IonSpectrumAnalyzer):
    """
    Experiment: Ion Spectrum Analyzer DDS Carrier Attenuation
    ...
    ***todo: redocument***
    ...
    """
    name = 'Ion Spectrum Analyzer DDS Carrier Attenuation'
