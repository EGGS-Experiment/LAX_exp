...
# todo: note that anti sigma_x must have phase/2 for actual phase b/c double-pass
...
class CatStateCharacterize(LAXExperiment, Experiment):
    ...
    kernel_invariants = {
        ...
        'phases_cat2_cat_pow', 'phases_cat2_cat_update_dir', 'ampl_729_readout_asf',
        'att_reg_sigmax', 'att_reg_bichromatic', 'att_reg_readout',
    ...
    def _build_arguments_cat1(self):
        ...
        self.setattr_argument("enable_cat1_sigmax",         BooleanValue(default=False), group='cat1.config',
                              tooltip='sigma_x selects whether motional state is displaced (True), or cat (False)')
