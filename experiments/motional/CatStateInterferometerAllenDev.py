...
class CatStateInterferometerTickleMS(LAXExperiment, Experiment):
    ...
    def pulse_ms(self,
        ...
        if self.enable_dynamical_decoupling:
            self.qubit.singlepass0_off()
            self.set_carrier_phase(self.phase_ms_dynamical_decoupling_pow,
                                   phase_track=True, ref_time_mu=ref_time_mu)
            self.qubit.singlepass0_on()
        with parallel:
    ...
    def set_default_configuration(self):
        ...
        self.freq_beams_ftw_list[self.index_729_ms][2] = self.qubit.freq_singlepass1_default_ftw - self.freq_secular_ftw_list[0] - self.freq_ms_gate_secular_detuning_ftw
        self.freq_beams_ftw_list[self.index_729_ms][3] = self.qubit.freq_singlepass2_default_ftw + self.freq_secular_ftw_list[0] + self.freq_ms_gate_secular_detuning_ftw
