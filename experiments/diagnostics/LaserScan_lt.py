...
class LaserScanLT(LAXExperiment, Experiment):
    """
    Experiment: Laser Scan LT
    ...
    def prepare_experiment(self):
        ...
        self.time_line_timeout_mu = self.get_parameter('time_timeout_ms', group='linetrigger',
                                                  override=False, conversion_function=seconds_to_mu, units=ms)
        self.time_line_holdoff_mu = self.get_parameter('time_holdoff_ms', group='linetrigger',
                                                  override=False, conversion_function=seconds_to_mu, units=ms)
    ...
    def run_main(self) -> TNone:
        ...
        for trial_num in range(self.repetitions):
            ...
            for freq_ftw in self.freq_qubit_scan_ftw:
                ...
                self.trigger_func(self.time_line_timeout_mu, self.time_line_holdoff_mu)
