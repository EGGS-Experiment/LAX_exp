...
class RabiFloppingRDX(EnvExperiment):
    ...
    def build(self):
        ...
        self.setattr_argument("time_cooling_readout_delay_us",  NumberValue(default=100, ndecimals=5, step=1, min=1, max=10000))
    ...
    def prepare(self):
        ...
        self.num_time_points_list = list(range(len(self.time_rabi_mu)))
