...
class ProphylacticSweep(EnvExperiment):
    ...
    def build(self):
        ...
        self.setattr_argument("mod_time_total_s",   NumberValue(default=20, precision=3, step=1, min=0.001, max=10000000, scale=1., unit="s"))
        self.setattr_argument("mod_att_db",         NumberValue(default=3, precision=1, step=0.5, min=0., max=31.5, scale=1., unit="dB"))
