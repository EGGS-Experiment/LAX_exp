...
class QubitAlignment(LAXExperiment, Experiment):
    ...
    def build_experiment(self):
        ...
        self.setattr_argument('time_total_s',       NumberValue(default=100, precision=0, step=100, min=5, max=100000, scale=1., unit="s"), group='timing')
        self.setattr_argument('samples_per_point',  NumberValue(default=50, precision=0, step=10, min=15, max=500), group='timing')

        # qubit
        self.setattr_argument('time_qubit_us',      NumberValue(default=100., precision=3, step=10, min=0.1, max=100000, scale=1., unit="us"), group='qubit')
        self.setattr_argument("freq_qubit_mhz",     NumberValue(default=101.1038, precision=5, step=1, min=1, max=10000, scale=1., unit="MHz"), group='qubit')
