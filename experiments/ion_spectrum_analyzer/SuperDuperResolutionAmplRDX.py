...
class SuperDuperResolutionAmplRDX(LAXExperiment, Experiment):
    """
    Experiment: Super Duper Resolution Ampl RDX
    ...
    kernel_invariants = {
        ...
        'rescue_subsequence', 'fock_subsequence', 'enable_RAP', 'enable_SBR',
