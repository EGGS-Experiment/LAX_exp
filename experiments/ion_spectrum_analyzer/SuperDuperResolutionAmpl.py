...
from LAX_exp.system.subsequences import (
    ...
    SidebandReadout, OverlapReadout, AgilePulseGenerator
)
...
class SuperDuperResolutionAmpl(LAXExperiment, Experiment):
    ...
    kernel_invariants = {
        ...
        'rescue_subsequence', 'enable_RAP', 'spinecho_wizard',

        # configs
        'profile_729_sb_readout', 'profile_729_SBC', 'profile_729_RAP', 'config_experiment_list',
        '_num_phaser_oscs',

        # motional overlap update
        'profile_729_fock', 'profile_729_overlap', 'fock_subsequence', 'overlap_subsequence'
    }
    ...
    def build_experiment(self):
        ...
        # instantiate fock state generation: arguments
    ...
    def prepare_experiment(self):
        ...
        if self.readout_type == 'RAP':
            ...
            freq_sideband_readout_ftw_list =    np.array([self.overlap_subsequence.freq_rap_center_ftw], dtype=np.int32)
            time_readout_mu_list =              np.array([self.overlap_subsequence.time_rap_mu], dtype=np.int64)
    ...
    def _prepare_waveform(self) -> TNone:
        ...
        for phase in self.phase_superresolution_sweep_turns_list:
            ...
            _osc_vals_blocks_local[:, :, 1] += self.phase_sweep_arr * phase
