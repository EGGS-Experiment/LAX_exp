...
class Spectroscopy397nmSpinpol(LAXExperiment, Experiment):
    """
    Experiment: Spectroscopy 397nm Spinpol

    Measures the linewidth of the S1/2 - P1/2 transition by doing a weak probe linescan
    using the sigma-minus polarized spinpol beam.
    """
    name = 'Spectroscopy 397nm Spinpol'


    def build_experiment(self):
        # core arguments
        self.setattr_argument("repetitions",                NumberValue(default=200, precision=0, step=1, min=1, max=100000))
        ...
        self.setattr_argument("freq_probe_scan_mhz",        Scannable(
                                                                default=RangeScan(85, 135, 151, randomize=True),
        ...
        self.setattr_argument("ampl_397nm_pct",             NumberValue(default=4, precision=3, step=10, min=1, max=50.), group='397nm')
    ...
    def prepare_experiment(self):
        ...
        ampl_calib_points =     self.get_dataset('calibration.beam_power.probe_beam.asf_calibration_curve_mhz_pct')
    ...
    def run_main(self):
        ...
        for trial_num in range(self.repetitions):
            ...
            for waveform_params in self.waveform_probe_scan:
                ...
                self.probe.set_mu(freq_ftw, asf=ampl_asf, profile=1)
                self.core.break_realtime()
