...
class RabiFlopping(LAXExperiment, Experiment):
    ...
    kernel_invariants = {
        ...
        # tmp remove - fock
        'profile_729_rsb', 'profile_729_bsb', 'profile_729_car',
        'freq_bsb_ftw', 'freq_rsb_ftw', 'att_fock_mu', 'ampl_fock_asf'
        # tmp remove - fock
    }
    ...
    def build_experiment(self):
        ...
        # tmp remove - fock
        self.profile_729_rsb =      2
        self.profile_729_bsb =      3
        self.profile_729_car =      4
        # tmp remove - fock
        ...
        self.pulseshape_subsequence =   QubitPulseShape(
            self, ram_profile=self.profile_729_readout, ram_addr_start=401,
            num_samples=50, ampl_max_pct=self.ampl_qubit_pct, pulse_shape='gaussian'
        )
    ...
    def initialize_experiment(self) -> TNone:
        ...
        # tmp remove - fock
        self.qubit.set_mu(self.freq_rsb_ftw, asf=self.ampl_fock_asf, profile=self.profile_729_rsb,
                          phase_mode=PHASE_MODE_CONTINUOUS)
        self.qubit.set_mu(self.freq_bsb_ftw, asf=self.ampl_fock_asf, profile=self.profile_729_bsb,
                          phase_mode=PHASE_MODE_CONTINUOUS)
        # tmp remove - fock
    ...
    def run_fock(self) -> TNone:
        ...
        # # D/n=1 => S/n=2
        # self.qubit.set_profile(self.profile_729_rsb)
        # self.qubit.cpld.io_update.pulse_mu(8)
        # self.qubit.on()
        # delay_mu(38370)
        # self.qubit.off()
