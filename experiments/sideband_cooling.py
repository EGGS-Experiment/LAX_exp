...
_DMA_HANDLE_DOPPLER = "sbc_doppler"
_DMA_HANDLE_STATEPREP = "sbc_stateprep"
_DMA_HANDLE_SIDEBAND = "sbc_sideband"
_DMA_HANDLE_READOUT = "sbc_readout"


class SidebandCooling(EnvExperiment):
    """
    Sideband Cooling.
    Does sideband cooling.
    """
    ...
    def build(self):
        ...
        self.setattr_argument("time_doppler_us",          NumberValue(default=100, ndecimals=5, step=1, min=1, max=1000))
        self.setattr_argument("time_stateprep_us",           NumberValue(default=100, ndecimals=5, step=1, min=1, max=1000))
        self.setattr_argument("time_sideband_us",           NumberValue(default=100, ndecimals=5, step=1, min=1, max=1000))
        self.setattr_argument("time_readout_us",           NumberValue(default=100, ndecimals=5, step=1, min=1, max=1000))
