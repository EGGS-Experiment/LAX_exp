...
class SidebandReadout(LAXSubsequence):
    ...
    def build_subsequence(self, profile_dds: TInt32 = 0) -> TNone:
        ...
        self.setattr_argument("freq_rsb_readout_mhz_list",      Scannable(
                                                                    default=[
                                                                        CenterScan(100.764, 0.04, 0.0006, randomize=True),
        ...
        self.setattr_argument("freq_bsb_readout_mhz_list",      Scannable(
                                                                    default=[
                                                                        CenterScan(101.43, 0.04, 0.0006, randomize=True),
        ...
        self.setattr_argument("time_sideband_readout_us",       NumberValue(default=26.37, precision=5, step=1, min=1, max=10000, scale=1., unit="us"), group=self.name)
