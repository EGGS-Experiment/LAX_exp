...
class SidebandReadout(LAXSubsequence):
    ...
    def build_subsequence(self):
        ...
        self.setattr_argument("time_sideband_readout_us",       NumberValue(default=129., ndecimals=5, step=1, min=1, max=10000), group=self.name)
