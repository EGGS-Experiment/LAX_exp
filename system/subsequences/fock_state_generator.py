...
class FockStateGenerator(LAXSubsequence):
    ...
    def prepare_subsequence(self):
        ...
        self.time_carrier_pi_pulse_mu = us_to_mu(self.time_carrier_pi_pulse_mu)
        ...
        self.time_pi_pulses_mu = np.zeros(len(self.fock_states))
        ...
        for idx, fock_state in enumerate(self.fock_states):
            ...
            if idx % 2 == 0:
                self.time_pi_pulses_mu[idx] = self.time_sideband_base_pi_pulse * np.sqrt(
        ...
        self.time_pi_pulses_mu = [us_to_mu(time_pi_pulses_us) for time_pi_pulses_us in self.time_pi_pulses_mu]
