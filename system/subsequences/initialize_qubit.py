...
class InitializeQubit(LAXSubsequence):
    ...
    def prepare_subsequence(self):
        self.time_spinpol_mu = self.get_parameter('time_spinpol_us', group='timing', override=True, conversion=seconds_to_mu, units=us)
        self.time_repump_qubit_mu = self.get_parameter('time_repump_qubit_us', group='timing', override=True, conversion=seconds_to_mu, units=us)
