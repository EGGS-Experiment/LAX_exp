...
class Squeeze(LAXSubsequence):
    ...
    def build_subsequence(self):
        self.setattr_argument('freq_squeeze_khz',           NumberValue(default=1088, ndecimals=3, step=10, min=1, max=400000), group='squeeze')
        self.setattr_argument('time_squeeze_us',            NumberValue(default=100, ndecimals=3, step=100, min=1, max=1000000), group='squeeze')
    ...
    def prepare_subsequence(self):
        ...
        self.att_squeeze_mu =                               att_to_mu(self.att_tickle_db * dB)
        self.phase_squeeze_pow =                            self.dds_modulation.turns_to_pow(self.phase_squeeze_turns)
    ...
    def initialize_subsequence(self):
        ...
        self.dds.set_mu(self.freq_squeeze_ftw, asf=self.dds_modulation.ampl_modulation_asf, _pow=self.phase_squeeze_pow, profile=0)
        self.dds.set_mu(self.freq_squeeze_ftw, asf=self.dds_modulation.ampl_modulation_asf, _pow=self.phase_antisqueeze_pow, profile=1)
        self.core.break_realtime()
