...
class DDSPulseShaperBi(HasEnvironment):
    ...
    def build(self, dds_targets: ad9910.AD9910 =None,
              ...
              ram_mode = ad9910.RAM_MODE_BIDIR_RAMP,
              time_roll_mu: TInt64 =  int64(2500),
        ...
        self.time_roll_mu = time_roll_mu
    ...
    def sequence_prepare(self, phase_autoclear: TInt32, dds_targets_idx: TInt32) -> TNone:
        ...
        :param dds_targets_idx: index of DDS targets
        :param roll_time_mu: roll time in machine units
        :param ram_mode: RAM mode
        """
    ...
    def sequence_initialize_single_dds(self, dds_targets_idx) -> TNone:
        ...
        dds_target.set_profile_ram(
                ...
                step=0xFFF,
                profile=self.ram_profile, mode=self.ram_mode,
        )
        dds_target.cpld.io_update.pulse_mu(8)
        delay_mu(10000)
    ...
    def run_single_dds(self, dds_targets_idx,
        ...
        if self.ram_mode == ad9910.RAM_MODE_BIDIR_RAMP:
            self.dds_targets[dds_targets_idx].cpld.set_profile(0)
            delay_mu(500)
        dds_target.sw.on()
    ...
    def configure_train_single_dds(self, dds_targets_idx, time_mu: TInt64) -> TInt64:
        ...
        dds_target.set_profile_ram(
            start=self.ram_addr_start, end=self.ram_addr_stop,
            step=time_ram_step,
            profile=self.ram_profile, mode=ad9910.RAM_MODE_BIDIR_RAMP
        )
        dds_target.cpld.io_update.pulse_mu(8)   # ensure profile is latched
