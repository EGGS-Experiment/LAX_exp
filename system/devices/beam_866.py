...
class Beam866(LAXDevice):
    ...
    def prepare_device(self):
        self.freq_repump_cooling_ftw = self.get_parameter('freq_repump_cooling_mhz', group='beams.freq_mhz', override=False, conversion=hz_to_ftw, units=MHz)
        self.ampl_repump_cooling_asf = self.get_parameter('ampl_repump_cooling_pct', group='beams.ampl_pct', override=False, conversion=pct_to_asf)
