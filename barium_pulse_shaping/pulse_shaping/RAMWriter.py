...
class RAMWriter(HasEnvironment):
    ...
    def build(self, dds_device: AD9910=None, dds_profile: TInt32=6, block_size: TInt32=88):
        ...
        :param dds_device: the DDS device object to write for. This MUST be an AD9910 object to prevent silly errors.
        :param dds_profile: the DDS profile (between [0, 7]) to use while writing RAM. Note that this profile does not
        ...
        :param block_size: the number of values to write at a time. Must be between [10, 150].
        """
