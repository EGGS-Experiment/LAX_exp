...
class TemperatureMeasurement(EnvExperiment):
    ...
    def build(self):
        ...
        self.setattr_argument("freq_probe_scan_mhz",                Scannable(
                                                                        default=RangeScan(85, 140, 56, randomize=True),
    ...
    def prepare(self):
        ...
        #asf_vals = np.array([.15625,.140625,.125,.125,.109375,.109375,.109375,.1171875,.1171875,.109375,.109375,.109375,.1171875,.1171875,.125,.125,.125,.140625,.140625,.15625,.15625,.1875,.21875,.25,.3125])
        # asf_vals = np.array([0.15625, 0.140625, 0.125, 0.1171875, 0.109375, 0.109375, 0.109375, 0.1171875, 0.1171875, 0.109375, 0.109375, 0.109375, 0.1171875, 0.125, 0.125, 0.125, 0.1328125, 0.140625, 0.140625, 0.15625, 0.171875, 0.203125, 0.25, 0.28125, 0.34375])
        # asf_vals = np.array([0.15625, 0.148926, 0.140625, 0.132324, 0.125, 0.120605, 0.117188, 0.112793,
        #                      0.109375, 0.108887, 0.109375, 0.108887, 0.109375, 0.113281, 0.117188, 0.118164,
        #                      0.117188, 0.113281, 0.109375, 0.108887, 0.109375, 0.108887, 0.109375, 0.112793,
        #                      0.117188, 0.121582, 0.125, 0.125488,0.125, 0.124512, 0.125, 0.128418, 0.132813,
        #                      0.137207, 0.140625, 0.140137, 0.140625, 0.147461, 0.15625, 0.163086, 0.171875,
        #                      0.185547, 0.203125, 0.226563, 0.25, 0.264648, 0.28125, 0.305664, 0.34375])
        #asf_vals = np.array(
        #    [0.5, 0.5, 0.33, 0.23, 0.19, 0.165, 0.155, 0.145, 0.135, 0.13,
        #     0.125, 0.12, 0.12, 0.12, 0.125, 0.13, 0.13, 0.135, 0.14, 0.155, 0.165,
        #     0.19, 0.225, 0.265, 0.315])
        asf_vals = np.array([0.40625, 0.34375, 0.296875, 0.265625, 0.234375, 0.21875,
                             0.203125, 0.1875, 0.1796875, 0.171875, 0.171875, 0.1640625,
                             0.16015625, 0.15625, 0.15625, 0.1484375, 0.1484375, 0.1484375,
                             0.140625, 0.140625, 0.140625, 0.140625, 0.140625, 0.140625, 0.140625,
                             0.14453125, 0.14453125, 0.1484375, 0.1484375, 0.1484375, 0.15234375,
                             0.15625, 0.15625, 0.15625, 0.1640625, 0.1640625, 0.1640625, 0.171875,
                             0.171875, 0.171875, 0.1796875, 0.1875, 0.1875, 0.1953125, 0.203125,
                             0.21875, 0.2265625, 0.2421875, 0.2578125, 0.2734375, 0.296875,
                             0.3125, 0.34375, 0.375, 0.390625, 0.421875])
