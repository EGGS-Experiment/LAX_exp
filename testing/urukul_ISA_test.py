...
class UrukulISATest(EnvExperiment):
    ...
    def _prepare_parameters_general(self):
        ...
        # empty waveform
        self.freq_empty_ftw =               self.dds.frequency_to_ftw(328.12 * MHz)
    ...
    def _run_prepare(self):
        ...
        at_mu(now_mu() + 25000)
        self.urukul0_ch1.set_mu(self.freq_rsb_ftw, asf=self.ampl_rsb_asf, pow_=self.phase_urukul0_ch1_pow, profile=0, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul0_ch2.set_mu(self.freq_bsb_ftw, asf=self.ampl_bsb_asf, pow_=self.phase_urukul0_ch2_pow, profile=0, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul0_ch3.set_mu(self.freq_carrier_ftw, asf=self.ampl_carrier_asf, pow_=self.phase_urukul0_ch3_pow, profile=0, phase_mode=PHASE_MODE_CONTINUOUS)

        at_mu(now_mu() + 25000)
        self.urukul1_ch1.set_mu(self.freq_rsb_ftw, asf=self.ampl_rsb_asf, pow_=self.phase_urukul1_ch1_pow, profile=0, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul1_ch2.set_mu(self.freq_bsb_ftw, asf=self.ampl_bsb_asf, pow_=self.phase_urukul1_ch2_pow, profile=0, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul1_ch3.set_mu(self.freq_carrier_ftw, asf=self.ampl_carrier_asf, pow_=self.phase_urukul1_ch3_pow, profile=0, phase_mode=PHASE_MODE_CONTINUOUS)


        '''PREPARE - DDS WAVEFORMS - EMPTY'''
        at_mu(now_mu() + 25000)
        self.urukul0_ch1.set_mu(self.freq_empty_ftw, asf=0x0, pow_=0x0, profile=1, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul0_ch2.set_mu(self.freq_empty_ftw, asf=0x0, pow_=0x0, profile=1, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul0_ch3.set_mu(self.freq_empty_ftw, asf=0x0, pow_=0x0, profile=1, phase_mode=PHASE_MODE_CONTINUOUS)

        at_mu(now_mu() + 25000)
        self.urukul1_ch1.set_mu(self.freq_empty_ftw, asf=0x0, pow_=0x0, profile=1, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul1_ch2.set_mu(self.freq_empty_ftw, asf=0x0, pow_=0x0, profile=1, phase_mode=PHASE_MODE_CONTINUOUS)
        self.urukul1_ch3.set_mu(self.freq_empty_ftw, asf=0x0, pow_=0x0, profile=1, phase_mode=PHASE_MODE_CONTINUOUS)
