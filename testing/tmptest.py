...
class testidkurukul(EnvExperiment):
    ...
    def _prepare_parameters(self):
        ...
        self.time_ch1_delay_ns =            1.66
        self.phase_ch1_inherent_turns =     0.
        self.phase_ch1_delay_turns =        (self.frequency_mhz * MHz) * (self.time_ch1_delay_ns * ns)
        ...
        self.phase_ch1_final_pow =          self.urukul0_ch0.turns_to_pow(self.phase_ch1_inherent_turns + self.phase_ch1_delay_turns + self.phase_turns1)
    ...
    def _run_prepare(self):
        ...
        with parallel:
            ...
            self.res10 = self.urukul1_ch3.set_mu(self.freq_ftw1, asf=0x01, pow_=0x0, profile=0)
        with parallel:
    ...
    def analyze(self):
        ...
        print('idk: {}'.format(self.urukul0_ch3.sync_data.io_update_delay))
