...
class UrukulRAMRamsey(EnvExperiment):
    ...
    Test AD9910 RAM use for Ramsey sequences.
    """
    ...
    def build(self):
        ...
        # self.setattr_argument("modulation_target",      EnumerationValue(list(self.dc_channel_dict.keys()), default='V Shim'), group='modulation')
    ...
    def prepare(self):
        ...
        self.data_modulation_length =       512
        self.data_modulation_arr =          np.zeros(self.data_modulation_length, dtype=np.int32)

        # calculate timings for ram profile (sample rate to num steps)
        ...
        '''CALCULATE WAVEFORM'''
        # for i in range(self.data_modulation_length):
